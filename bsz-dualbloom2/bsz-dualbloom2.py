...
plugin = PlugIn(
    "Dual Bloom 2",
    dual_bloom_2,
    ParamNumber("Amount High", 15, 0, 100),
    ParamNumber("Amount Low", 35, 0, 100),
    ParamNumber("Softness High", 25, 0, 100),
    ParamNumber("Softness Low", 25, 0, 100),
    ParamNumber("Radius High", 10, 0, 1500),
    ParamNumber("Radius Low", 10, 0, 1500),
    ParamNumber("Strength High", 50, 0, 1000),
    ParamNumber("Strength Low", 50, 0, 1000),
    description="WIP",
...
#     def run(self, drawable, amount_high, amount_low,
#             softness_high, softness_low, radius_high, radius_low,
#             strength_high, strength_low):
...
#     # I decided to name the function called by the PDB procedure 'main'
